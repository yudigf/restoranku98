    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Silakan ubah isi data karyawan yang ingin diubah</p>
            </div>
        </div>
    </div>
    <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group d-flex justify-content-end">
                                ...
                                <a href="{{ route('users.index') }}" type="submit" class="btn btn-primary me-1 mb-1">Batal</a>
                            </div>
